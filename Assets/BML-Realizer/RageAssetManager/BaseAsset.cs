...
namespace AssetPackage
{
    ...
    using AssetManagerPackage;  // contains RageExtensions
    ...
    public class BaseAsset : IAsset
    {
        ...
        public BaseAsset()
        {
            ...
            {
                Log(Severity.Verbose, "{0} VersionInfo is missing", GetType().Name);   // this.GetType().Name
            }
        }
    ...
    //}
     ...
     //The remaining eight are members of Object, the type from which all classes and interfaces in the .NET type system ultimately implicitly inherit.

            using (Stream stream = GetType().Assembly().GetManifestResourceStream(path))

            // Error: https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs0121?f1url=%3FappId%3Droslyn%26k%3Dk(CS0121)
            // this.GetType(): Note that this method is not marked as virtual, but behaves like a virtual – for each object returns the actual type.
            // This is due to the special, internal implementation. 
            // this.GetType().Assembly() ==     /// </returns>
            ...
            // https://docs.microsoft.com/en-us/dotnet/api/system.type.assembly?view=net-6.0
            // Get the Assembly System.Runtime.dll in which the type is declared.
